...
class App extends Component {
  ...
  render() {
    ...
    const About = [{name: "Jesse Horwitz", imageSrc: "./imgs/thesis4.png", projLink: "https://www.linkedin.com/in/j-horwitz/", subText:"<button><a href='https://www.linkedin.com/in/j-horwitz/'>Linkedin</a></button><button><a href='https://github.com/SuperJesseH'>Github</a></button><button><a href='http://www.twitter.com/superjesseh'>Twitter</a></button>", desc: "<p>Full stack web developer with a passion for solving urban issues and finding new applications for emerging technology. I have experience working with Ruby on Rails, JavaScript, and React and a background in social science, digital media, hardware and product development.</p><p>I like working on projects that take complex data sets or systems and make them casually accessible for users. When I was an Analyst at MTV I worked with analytics data from 12 different mobile apps and built reports, presentations and interactive spreadsheets to help others in the company make decisions about content and marketing. In graduate school at NYU’s ITP, I built interactive tech products that would collect unusual datasets and surface this information to users in fun or provocative ways. A good example of this is my thesis project, Radius, which is a compact device that can sniff WiFi signals and estimate how many people are in the surrounding area. With the data I've collected on Radius, I have been able to create a new type of geo-social map reflecting the ‘experienced population density’ in cities, towns, and rural areas. Since then I’ve focused on solidifying my software development abilities so I can apply my existing interests and skills to a new set of problems, collaborate with bigger teams and build products that reach a larger audience. </p><p>Looking forward I’m interested in working on web based apps, hardware, and data analysis. Anything related to civic/urban tech, infrastructure or interactivity is appealing to me. Outside of those interests, I’ve been studying Machine Learning with Tensorflow, decentralized computing and digital fabrication with 3D printers, Laser cutters and CNCs. </p><p>I’m also co-founder of ProDigit Accessories where I manufacture smartphone and other tech accessories on a part-time basis.</p><p>I can be reached by email, on LinkedIn or twitter. Let me know how we can work together. </p>"}]
